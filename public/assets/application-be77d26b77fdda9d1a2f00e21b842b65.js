 ...
 *
 *  The above will open a facebox with "some html" as the popcontent.
 *
 ...
 *
 *  The facebox function can also display an ajax page, an image, or the popcontents of a div:
 *
 ...
 *
 *   $(document).bind('reveal.facebox', function() { ...stuff to do after the facebox and popcontents are revealed... })
 *
 */
...
(function($) {
  ...
  $.extend($.facebox, {
    ...
    reveal: function(data, klass) {
      ...
      if (klass) $('#facebox .popcontent').addClass(klass)
      $('#facebox .popcontent').append(data)
    ...
    close: function() {
      javascript:void callPlayer("yid","stopVideo");
  ...
  $.fn.facebox = function(settings) {
    ...
    function clickHandler() {
      ...
      var klass = this.rel.match(/facebox/)
  ...
  $(document).bind('close.facebox', function() {
    ...
    $('#facebox').fadeOut(function() {
      $('#facebox .popcontent').removeClass().addClass('popcontent')
      $('#facebox .loading').remove()
